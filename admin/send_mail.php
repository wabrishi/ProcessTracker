<?php
// Admin Send Mail Page
// Allows Admin to send custom emails to any candidate
...
// Get all candidates (Admin can send to any)
$candidates = getCandidatesForMail(null); // null = all candidates
...
// Get assigned HR name
function getHrName($hrId, $users) {
...
<div class="page-header">
    ...
    <div class="header-actions">
        <a href="index.php?page=admin&menu=mail_logs" class="btn btn-secondary">📋 View Mail Logs</a>
    </div>
</div>
            ...
            <form method="post" id="mailForm">
                ...
                <div class="form-group">
                    ...
                    <select name="candidate_id" id="candidateSelect" required onchange="this.form.submit()">
                        ...
                        <?php foreach ($candidates as $id => $cand): 
                            ...
                            $hrName = getHrName($assignedTo, $users);
                        ?>
                ...
                <?php if ($selectedCandidate): ?>
                    <div class="candidate-info-card">
                        ...
                        <p><strong>Assigned HR:</strong> <?php echo getHrName($selectedCandidate['assigned_to'] ?? '-', $users); ?></p>
                    </div>
                <?php endif; ?>
